      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Tableau de board</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Gestion des contributeurs</h6>
        </nav>
            ...
            <div class="card card-profile overflow-hidden">
              <div class="row">
                   <div class="card">
                    ...
                    <div class="card-body">
                      <h5 class="mb-0"><?php echo $row['fullName'] ?></h5>
                      <a href="contributions.html" class="btn btn-sm bg-jaunefond text-white">Gérer ces posts</a>
                      <?php 
